...
| M19 | Templates y nombres canónicos para TODOS los agentes (no solo R1-R4) | 2026-03-21 | Los 7 templates cubren thesis/ pero hay 24 agentes que generan outputs en world/sectors/, reports/, state/. Sector views, smart money reports, stress tests — todos deberían tener template + nombres canónicos + meta-reflexión donde haya juicio (no datos puros). | **ALTA** | ❌ PENDIENTE |
