# Daily Report — [DÍA] [DD] [MES] [AÑO]

## 1. Portfolio vs S&P 500

![Portfolio vs S&P 500](images/portfolio_vs_sp500_YYYY-MM-DD.png)
...
|------|----------|---------|
| R1 thesis.md | X | [tickers] |
| R2 devils_advocate.md | X | [tickers] |
| R3 resolutions | X | [tickers] |
| R4 committee | X | [tickers] |
| Sector views refreshed | X | |
| Smart money reports | X | |
| KC sweeps | X | |
| Stress test | X | |
