...
| R2 DA | 5 (MELI, LNTH, WRB, CHKP, BEAN.SW) |
...
| Stage | Cantidad |
|-------|----------|
| R4 approved (listos para comprar) | 8 (GDDY, DNLM.L, ITRK.L, BCG.L, CMCSA, SPGI, MEGP.L, ALFA.L) |
...
- **E[CAGR] deployed post-Mar 26:** 17.6% (+0.3pp)
- **E[CAGR] blended (incl cash):** 15.2% → 15.8% (+0.6pp)
- **Gap al 30%:** -14.2pp
- **Worst position mejora:** FTNT 10.2% → TW 13.0% (+2.8pp floor)
