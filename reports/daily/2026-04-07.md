...
**Pendientes 09:00 CET:**
- TRIM EDEN.PA: ~50 units (82→~32), 13%→6%. Zero-base test + shorts 10% + consensus collapsed.
- BUY MEGP.L: EUR 600. Posición faltante en eToro demo.

**¿Por qué?** EDEN.PA zero-base test mostró que abriríamos 4-5% desde cero, no 13%. Path dependency corregida. EV del trim pre-Q1 es negativo (-EUR 18). MEGP.L simplemente no se ejecutó en marzo.
